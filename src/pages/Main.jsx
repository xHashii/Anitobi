...
import logo from '../assets/images/Anitobi-logo.png'
import zoro from '../assets/images/kakashi_hatake_render.png'
  ...
  return (
    <>
      ...
      <M.Container>
        ...
        <M.BoxWrapper>
          <M.BoxLeft>
            <h1 style={{ color: '#fff', fontSize: '28px' }}>
              Anitobi.to - The best site to watch anime online for Free
            </h1>
            <p>
              ...
              Anitobi.to to be one of the best free anime streaming site for all
        ...
        <M.Footer>
          <p>©2024 Anitobi.to. All rights reserved.</p>
